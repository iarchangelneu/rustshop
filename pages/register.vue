            ...
            <div class="form__body">
                ...
                <div class="inputs">
                    ...
                    <div>
                        ...
                        <div class="showpass">
                            <input :type="showPassword ? 'text' : 'password'" name="repeat__password" id="repeat__password"
...
<script setup>
useSeoMeta({
    title: 'Регистрация | RustShop',
    ogTitle: 'Регистрация | RustShop',
    description: 'Регистрация | RustShop',
    ogDescription: 'Регистрация | RustShop',
})
</script>
