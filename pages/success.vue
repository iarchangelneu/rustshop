...
<script setup>
useSeoMeta({
    title: 'Транзакция прошла успешно | RustShop',
    ogTitle: 'Транзакция прошла успешно | RustShop',
    description: 'Транзакция прошла успешно | RustShop',
    ogDescription: 'Транзакция прошла успешно | RustShop',
})
</script>
